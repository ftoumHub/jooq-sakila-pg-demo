...
import org.jooq.sources.tables.records.FilmListRecord;
...
public class FilmList extends TableImpl<FilmListRecord> {
     ...
     */
    public final TableField<FilmListRecord, MpaaRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR.asEnumDataType(org.jooq.sources.enums.MpaaRating.class), this, "");
