...
import org.jooq.sources.enums.MpaaRating;
...
public class Film extends TableImpl<FilmRecord> {
     ...
     */
    public final TableField<FilmRecord, Integer> RELEASE_YEAR = createField(DSL.name("release_year"), org.jooq.sources.Domains.YEAR.getDataType(), this, "");
     ...
     */
    public final TableField<FilmRecord, MpaaRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR.defaultValue(DSL.field("'G'::mpaa_rating", SQLDataType.VARCHAR)).asEnumDataType(org.jooq.sources.enums.MpaaRating.class), this, "");
