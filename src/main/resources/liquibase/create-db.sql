...
ALTER PROCEDURAL LANGUAGE plpgsql OWNER TO sakilapg;
...
ALTER TABLE public.actor_actor_id_seq OWNER TO sakilapg;
...
ALTER TABLE public.actor OWNER TO sakilapg;
...
ALTER TYPE public.mpaa_rating OWNER TO sakilapg;
...
ALTER DOMAIN public.year OWNER TO sakilapg;
...
ALTER FUNCTION public._group_concat(text, text) OWNER TO sakilapg;
...
ALTER AGGREGATE public.group_concat(text) OWNER TO sakilapg;
...
ALTER TABLE public.category_category_id_seq OWNER TO sakilapg;
...
ALTER TABLE public.category OWNER TO sakilapg;
...
ALTER TABLE public.film_film_id_seq OWNER TO sakilapg;
...
ALTER TABLE public.film OWNER TO sakilapg;
...
ALTER TABLE public.film_actor OWNER TO sakilapg;
...
ALTER TABLE public.film_category OWNER TO sakilapg;
...
ALTER TABLE public.actor_info OWNER TO sakilapg;
...
ALTER TABLE public.address_address_id_seq OWNER TO sakilapg;
...
ALTER TABLE public.address OWNER TO sakilapg;
...
ALTER TABLE public.city_city_id_seq OWNER TO sakilapg;
...
ALTER TABLE public.city OWNER TO sakilapg;
...
ALTER TABLE public.country_country_id_seq OWNER TO sakilapg;
...
ALTER TABLE public.country OWNER TO sakilapg;
...
ALTER TABLE public.customer_customer_id_seq OWNER TO sakilapg;
...
ALTER TABLE public.customer OWNER TO sakilapg;
...
ALTER TABLE public.customer_list OWNER TO sakilapg;
...
ALTER TABLE public.film_list OWNER TO sakilapg;
...
ALTER TABLE public.inventory_inventory_id_seq OWNER TO sakilapg;
...
ALTER TABLE public.inventory OWNER TO sakilapg;
...
ALTER TABLE public.language_language_id_seq OWNER TO sakilapg;
...
ALTER TABLE public.language OWNER TO sakilapg;
...
ALTER TABLE public.nicer_but_slower_film_list OWNER TO sakilapg;
...
ALTER TABLE public.payment_payment_id_seq OWNER TO sakilapg;
...
ALTER TABLE public.payment OWNER TO sakilapg;
...
ALTER TABLE public.payment_p2007_01 OWNER TO sakilapg;
...
ALTER TABLE public.payment_p2007_02 OWNER TO sakilapg;
...
ALTER TABLE public.payment_p2007_03 OWNER TO sakilapg;
...
ALTER TABLE public.payment_p2007_04 OWNER TO sakilapg;
...
ALTER TABLE public.payment_p2007_05 OWNER TO sakilapg;
...
ALTER TABLE public.payment_p2007_06 OWNER TO sakilapg;
...
ALTER TABLE public.rental_rental_id_seq OWNER TO sakilapg;
...
ALTER TABLE public.rental OWNER TO sakilapg;
...
ALTER TABLE public.sales_by_film_category OWNER TO sakilapg;
...
ALTER TABLE public.staff_staff_id_seq OWNER TO sakilapg;
...
ALTER TABLE public.staff OWNER TO sakilapg;
...
ALTER TABLE public.store_store_id_seq OWNER TO sakilapg;
...
ALTER TABLE public.store OWNER TO sakilapg;
...
ALTER TABLE public.sales_by_store OWNER TO sakilapg;
...
ALTER TABLE public.staff_list OWNER TO sakilapg;
...
ALTER FUNCTION public.film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO sakilapg;
...
ALTER FUNCTION public.film_not_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO sakilapg;
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp without time zone) OWNER TO sakilapg;
...
ALTER FUNCTION public.inventory_held_by_customer(p_inventory_id integer) OWNER TO sakilapg;
...
ALTER FUNCTION public.inventory_in_stock(p_inventory_id integer) OWNER TO sakilapg;
...
ALTER FUNCTION public.last_day(timestamp without time zone) OWNER TO sakilapg;
...
ALTER FUNCTION public.last_updated() OWNER TO sakilapg;
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO sakilapg;
...
GRANT ALL ON SCHEMA public TO sakilapg;
